...
<head>
    ...
    <title>Admin Login - Desa Banteran</title>
...
<body class="bg-indigo-200">
    <div class="h-screen flex flex-col justify-center items-center mx-3">
        ...
        <div class="w-full max-w-md p-5 mb-5 bg-green-200 text-center text-green-600 text-base rounded-xl border-2 border-green-500">
        {{ $message }}
        </div>
        ...
        @endif
        <div class="w-full max-w-md p-4 rounded-lg shadow-md sm:p-6 md:p-8 bg-[#040f39] border-gray-700">
            <form class="space-y-6" action="{{ route('auth.validate_login') }}" method="POST">
                <a href="{{ route('beranda') }}" class="ml-auto text-sm hover:underline text-white"><i class="fa-solid fa-chevron-left"></i> Kembali ke Beranda</a>
                ...
                <button type="submit" class="w-full text-white focus:ring-1 focus:outline-none font-medium rounded-lg text-sm px-5 py-3 text-center bg-[#2563eb] hover:bg-[#164bbf] focus:ring-[#2563eb]">
                    Login
                </button>
            </form>
        </div>
