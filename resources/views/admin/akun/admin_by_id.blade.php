...
<div class="p-5 mt-5">
    <a href="{{ route('akun_admin') }}" class="py-2 px-4 bg-blue-500 hover:bg-blue-600 text-white rounded-xl">
            ...
            <form class="space-y-4" action="update/{{ $d->id }}" method="POST">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ $d->name }}"
                        class="bg-gray-300 border-gray-200 placeholder-gray-500 text-gray-700 text-sm rounded-lg block w-full p-3" 
