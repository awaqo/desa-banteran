...
<div class="p-8">
    <h1 class="text-2xl font-medium text-indigo-800 pb-6">Dashboard</h1>
    <div class="flex flex-wrap gap-5">
        ...
        <div class="min-w-[20rem] p-6 flex flex-col items-center gap-3 bg-blue-100 border border-gray-200 rounded-lg shadow-blue-300 shadow-md">
            <i class="fa-solid fa-hand-holding-hand text-5xl mt-3 text-blue-600 opacity-40"></i>
            <div>
                <h5 class="mb-2 text-2xl font-semibold tracking-tight text-blue-800">Data penerima bantuan</h5>
                <p class="mb-3 text-center font-bold text-4xl text-blue-600 opacity-60">{{ $bantuan }}</p>
            </div>
        </div>
