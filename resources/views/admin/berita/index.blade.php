...
@section('content-admin')
    <div class="p-5">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <form action="{{ url('admin/berita/hapus-berita') }}" method="POST">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah Anda yakin ingin menghapus postingan
                                berita ini?</h3>
        ...
        {{-- Tambah data --}}
        <div class="my-4">
            <a id="posting-berita" href="{{ route('post_berita') }}"
            ...
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody class="bg-white divide-y">
                    @if ($dataBerita->count() < 1)
                        <tr>
                            <td colspan="6" class="py-4 px-6 text-center text-lg">Belum ada postingan berita</td>
                        </tr>
                    @else
                            ...
                            <tr class="divide-x">
                                ...
                                <td class="w-32 text-center py-4 px-6">
                                    <div class="flex items-center space-x-2">
                                        <a href="{{ url('admin/berita/' . $d->slug) }}"
                                        ...
                                        <a href="{{ url('admin/berita/edit/' . $d->slug) }}"
                                            class="py-2 px-3 rounded-md text-white bg-yellow-500 hover:bg-yellow-600"
                                            data-tooltip-target="tooltip-edit" data-tooltip-style="light">
