<header class="w-full items-center bg-indigo-900 shadow-md py-4 px-6 hidden sm:flex">
    <div class="w-1/2"></div>
    <div class="w-1/2 flex justify-end">
        <div class="relative">
            <img id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="p-1 w-10 h-10 rounded-full cursor-pointer ring-2 ring-indigo-300" src="{{ asset('images/user.png') }}" alt="User dropdown">
        ...
        <div id="userDropdown" class="hidden z-10 w-44 rounded divide-y shadow bg-gray-700 divide-gray-600">
            ...
            <ul class="py-1 text-sm text-gray-200" aria-labelledby="avatarButton">
                <li>
                    <a href="{{ route('akun_admin') }}" class="block py-2 px-4 hover:bg-gray-600 hover:text-white">Detail Akun</a>
                </li>
            </ul>
            <div class="py-1">
