...
@section('content')
    <div class="flex flex-col justify-center items-center">
            ...
            <div class="relative w-full h-full max-w-lg md:h-auto">
                <div class="relative bg-white rounded-lg shadow">
                    <div class="flex items-start justify-between p-4 border-b rounded-t">
                        ...
                        <button type="button"
                            class="absolute top-3 right-2.5 text-indigo-400 bg-transparent hover:bg-indigo-200 hover:text-indigo-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                            data-modal-toggle="cekBantuan">
        ...
        <div class="mt-10 mb-5 w-full sm:max-w-5xl flex justify-end">
            <button data-modal-target="cekBantuan" data-modal-toggle="cekBantuan" type="button"
                class="py-3 px-5 mx-auto md:mx-4 lg:mx-0 rounded-md w-full max-w-xs text-white bg-emerald-500 hover:bg-emerald-600">
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody class="bg-white divide-y">
                        @if ($dataBantuan->count() < 1)
                            <tr>
                                <td colspan="5" class="py-4 px-6 text-center text-lg">Belum ada data penerima bantuan
                                </td>
                            </tr>
                        @else
                            @php $i=1 @endphp
